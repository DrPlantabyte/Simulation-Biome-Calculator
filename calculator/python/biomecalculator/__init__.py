"""
This module provides several function for estimating the Dr. Plantabyte biome code for a given Earthly or exoplanet
environment. If you have Cython installed, it will use Cython-optimized calculations to improve performance.

For more information on Dr. Plantabyte's biome codes, see the biomecalculator.biomes module and the
biomecalculator.biomes.Biome enum.
...
Macapa_Brazil={'mean_solar_flux_Wpm2': 798, 'pressure_kPa': 101.3, 'altitude_m': 20, 'mean_temp_C': 28.2,
  'temp_var_C': 3.2, 'annual_precip_mm': 2200}
print(biomecalculator.classify_biome(**Macapa_Brazil))
>>> Biome.JUNGLE
Fairbanks_Alaska={'mean_solar_flux_Wpm2': 356, 'pressure_kPa': 99.8, 'altitude_m': 136, 'mean_temp_C': -2.0,
  'temp_var_C': 21.7, 'annual_precip_mm': 296}
print(biomecalculator.classify_biome(**Fairbanks_Alaska))
>>> Biome.TUNDRA
# Predict biome at a location on Mars
Mars={'planet_mass_kg': 6.417e23, 'planet_mean_radius_km': 3.390e3, 'toa_solar_flux_Wpm2': 590,
...
biome_map = biomecalculator.classify_planet_biomes(9.81, 101.3, solar_flux_map, altitude_map,
  temperature_map, temp_variation_map, rainfall_map, exoplanet=False)
print(biome_map)
>>> [[ 7  8 21 ... 16 21  7]
>>>  [ 8 16  8 ...  8 21  8]
>>>  [21  8  8 ...  7  7 16]
